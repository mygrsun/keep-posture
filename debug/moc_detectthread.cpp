...
QT_MOC_LITERAL(4, 41, 6)
    ...
    "DetectThread\0getResult\0\0Detectheadresult\0"
    "result\0"
};
...
void DetectThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->getResult((*reinterpret_cast< Detectheadresult(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DetectThread::*_t)(Detectheadresult );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DetectThread::getResult)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void DetectThread::getResult(Detectheadresult _t1)
{
